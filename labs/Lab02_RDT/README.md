...
- The tutorial has three Jupyter notebooks and one folder:
    ...
    - **SocketLab.ipynb**: Configures the IPv4/IPv6 network address, downloads the ospf software, and then begins the OSPF tutorial
...
```
   ...
   - Run the Tutorial Notebooks
        ...
        - Then open and execute the SocketLab.ipynb
